...
import randomName from "@/js/randomName";
import deviceInfo from "@/js/deviceInfo";
import RoomClient from "@/js/RoomClient";
...
export default {
  run: async function run() {
    ...
    store.commit(stateActions.setRoomUrl(roomUrl));
    store.commit(stateActions.setRoomFaceDetection(faceDetection));
    store.commit(stateActions.setMe({ peerId, displayName, displayNameSet, device }));
