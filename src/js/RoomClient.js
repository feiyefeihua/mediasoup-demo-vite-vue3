...
export default class RoomClient {
      ...
      switch (request.method) {
        case "newConsumer": {
          ...
          try {
            ...
            if (consumer.kind === "video" && store.state.me.audioOnly) this._pauseConsumer(consumer);
          } catch (error) {
    ...
    this._protoo.on("notification", (notification) => {
      ...
      switch (notification.method) {
        case "producerScore": {
          ...
          store.commit(stateActions.setProducerScore(producerId, score));
        ...
        case "newPeer": {
          ...
          store.commit(stateActions.addPeer({ ...peer, consumers: [], dataConsumers: [] }));
        ...
        case "peerDisplayNameChanged": {
          ...
          store.commit(stateActions.setPeerDisplayName(displayName, peerId));
        ...
        case "consumerPaused": {
          ...
          store.commit(stateActions.setConsumerPaused(consumerId, "remote"));
        ...
        case "consumerResumed": {
          ...
          store.commit(stateActions.setConsumerResumed(consumerId, "remote"));
        ...
        case "consumerLayersChanged": {
          ...
          store.commit(stateActions.setConsumerCurrentLayers(consumerId, spatialLayer, temporalLayer));
        ...
        case "consumerScore": {
          ...
          store.commit(stateActions.setConsumerScore(consumerId, score));
        ...
        case "activeSpeaker": {
          ...
          store.commit(stateActions.setRoomActiveSpeaker(peerId));
  ...
  async disableMic() {
    ...
    store.commit(stateActions.removeProducer(this._micProducer.id));
  ...
  async muteMic() {
    ...
    try {
      ...
      store.commit(stateActions.setProducerPaused(this._micProducer.id));
    } catch (error) {
  ...
  async unmuteMic() {
    ...
    try {
      ...
      store.commit(stateActions.setProducerResumed(this._micProducer.id));
    } catch (error) {
  ...
  async enableWebcam() {
    ...
    store.commit(stateActions.setWebcamInProgress(true));
    ...
    store.commit(stateActions.setWebcamInProgress(false));
  }
  ...
  async disableWebcam() {
    ...
    store.commit(stateActions.removeProducer(this._webcamProducer.id));
  ...
  async changeWebcam() {
    ...
    try {
      ...
      store.commit(stateActions.setProducerTrack(this._webcamProducer.id, track));
    } catch (error) {
  ...
  async enableShare() {
    ...
    store.commit(stateActions.setShareInProgress(true));
    ...
    try {
      ...
      if (this._useSharingSimulcast) {
        ...
        if ((this._forceVP9 && codec) || firstVideoCodec.mimeType.toLowerCase() === "video/vp9") {
          ...
          encodings = SCREEN_SHARING_SIMULCAST_ENCODINGS.map((encoding) => ({ ...encoding, dtx: true }));
        }
      }
    ...
    store.commit(stateActions.setShareInProgress(false));
  }
  ...
  async disableShare() {
    ...
    store.commit(stateActions.removeProducer(this._shareProducer.id));
  ...
  async enableAudioOnly() {
    ...
    store.commit(stateActions.setAudioOnlyInProgress(true));
    ...
    store.commit(stateActions.setAudioOnlyState(true));

    store.commit(stateActions.setAudioOnlyInProgress(false));
  }
  ...
  async disableAudioOnly() {
    ...
    store.commit(stateActions.setAudioOnlyState(false));
  ...
  async muteAudio() {
    ...
    store.commit(stateActions.setAudioMutedState(true));
  }

  async unmuteAudio() {
    logger.debug("unmuteAudio()");

    store.commit(stateActions.setAudioMutedState(false));
  }

  async restartIce() {
    logger.debug("restartIce()");

    store.commit(stateActions.setRestartIceInProgress(true));
    ...
    store.commit(stateActions.setRestartIceInProgress(false));
  }
  ...
  async setConsumerPreferredLayers(consumerId, spatialLayer, temporalLayer) {
    ...
    try {
      ...
      store.commit(stateActions.setConsumerPreferredLayers(consumerId, spatialLayer, temporalLayer));
    } catch (error) {
  ...
  async setConsumerPriority(consumerId, priority) {
    ...
    try {
      ...
      store.commit(stateActions.setConsumerPriority(consumerId, priority));
    } catch (error) {
  ...
  async changeDisplayName(displayName) {
    ...
    try {
      ...
      store.commit(stateActions.setDisplayName(displayName));
      ...
      // displayName again.
      store.commit(stateActions.setDisplayName());
    }
  }
  ...
  async _joinRoom() {
    ...
    try {
      ...
      store.commit(stateActions.removeAllNotifications());
      ...
      if (window.SHOW_INFO) {
        ...
        store.commit(stateActions.setRoomStatsPeerId(me.id));
      }
    } catch (error) {
  ...
  async _updateWebcams() {
    ...
    store.commit(stateActions.setCanChangeWebcam(this._webcams.size > 1));
  }
  ...
  async _pauseConsumer(consumer) {
    ...
    try {
      ...
      store.commit(stateActions.setConsumerPaused(consumer.id, "local"));
    } catch (error) {
  ...
  async _resumeConsumer(consumer) {
    ...
    try {
      ...
      store.commit(stateActions.setConsumerResumed(consumer.id, "local"));
    } catch (error) {
  ...
  async _getExternalVideoStream() {
    ...
    else if (this._externalVideo.mozCaptureStream) this._externalVideoStream = this._externalVideo.mozCaptureStream();
